...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const employTypeLocation = locationTypesChecked.join(',')
    console.log(employTypeLocation)
    const employTypes = employmentTypesChecked.join(',')
    console.log(employTypes)
    const jwtToken = Cookies.get('jwt_token')
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employTypes}&location=${employTypeLocation}&minimum_package=${activeSalaryRangeId}&search=${searchInput}`
